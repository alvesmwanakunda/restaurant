...
@Component({
  selector: 'app-relancer-message',
  templateUrl: './relancer-message.component.html',
  styleUrls: ['./relancer-message.component.scss'],
  encapsulation: ViewEncapsulation.None,
  host:{class:'app-relancer-message'}
})
export class RelancerMessageComponent implements OnInit {
  ...
  getMessage(id){
    this.messageService.getByTypeMessageVisiteApp("Relancer",id).subscribe((res:any)=>{
      try {
           this.messageClient = res.message;
